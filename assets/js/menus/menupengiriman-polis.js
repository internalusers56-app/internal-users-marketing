// File: assets/js/menus/menupengiriman-polis.js

function initPage() {
    console.log("Pengiriman Polis page initialized.");
    ...
    const tableBody = document.querySelector('#pengiriman-polis-table tbody');
    ...
    function advancedFilterTable() {
        ...
        for (let i = 0; i < rows.length; i++) {
            const row = rows[i];
            const rowDateText = row.cells[5].textContent; // Kolom Tgl Kirim
            const rowStatus = row.cells[8].textContent;   // Kolom Status
